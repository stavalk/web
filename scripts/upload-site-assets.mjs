/**
 * Uploads site media to R2 under `site/*` (CDN: https://assets.stavalk.com/site/*).
 *
 ...
 * them uses hardcoded CDN links (https://assets.stavalk.com/site/...).
 *
...
const BUCKET = process.env.R2_BUCKET ?? `${process.env.SITE_ID ?? 'stavalk'}-files-prod`
