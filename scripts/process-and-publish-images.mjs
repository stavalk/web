 ...
 * og-default-768.avif / -480.avif hero URLs in src/config/branding.ts.
 ...
 *   node scripts/process-and-publish-images.mjs --src scripts/stavalk-images # S3 mode, upload everything
