...
export function ProjectPage({ page, related }: { page: ProjectData; related: ProjectRelated[] }) {
  ...
  const snapshot = [
    { icon: Building2, label: t('bench.projects.snapshot.customerType'), value: page.customerType },
    { icon: Globe2, label: t('bench.projects.snapshot.region'), value: page.region },
    { icon: Package, label: t('bench.projects.snapshot.productCategory'), value: page.productCategory },
    { icon: Layers, label: t('bench.projects.snapshot.projectStage'), value: page.projectStage },
    { icon: ClipboardList, label: t('bench.projects.snapshot.manufacturingScope'), value: page.manufacturingScope },
    { icon: CheckCircle2, label: t('bench.projects.snapshot.keyRequirements'), value: page.keyRequirements },
    { icon: ShieldCheck, label: t('bench.projects.snapshot.qualityFocus'), value: page.qualityFocus },
    { icon: Truck, label: t('bench.projects.snapshot.outcome'), value: page.outcome },
  ]
  ...
  return (
    <MarketingShell>
      ...
      <section className="mx-auto max-w-6xl px-5 py-14 md:px-7">
        <SectionHead kicker={t('bench.projects.snapshot.kicker')} title={t('bench.projects.snapshot.title')} />
          ...
          <dl className="grid gap-5 md:grid-cols-3">
            <div className="marine-card p-6">
              <dt className="flex items-center gap-2 text-[12px] font-bold uppercase tracking-[0.12em] text-fg-3">
                <Building2 size={15} className="text-primary" /> {t('bench.projects.industry')}
              </dt>
              <dd className="mt-2 text-[15px] font-semibold">{page.industry}</dd>
            </div>
            <div className="marine-card p-6">
              <dt className="flex items-center gap-2 text-[12px] font-bold uppercase tracking-[0.12em] text-fg-3">
                <ClipboardList size={15} className="text-primary" /> {t('bench.projects.requirement')}
              </dt>
              <dd className="mt-2 text-[15px] font-semibold">{page.requirement}</dd>
            </div>
            <div className="marine-card p-6">
              <dt className="flex items-center gap-2 text-[12px] font-bold uppercase tracking-[0.12em] text-fg-3">
                <Package size={15} className="text-primary" /> {t('bench.projects.product')}
              </dt>
      ...
      <section className="border-y border-border bg-bg-alt">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-7 md:py-20">
          <SectionHead kicker={t('bench.projects.storyKicker')} title={t('bench.projects.storyTitle')} />
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            <div className="marine-card p-6">
              <p className="text-[13px] font-bold uppercase tracking-[0.1em] text-sun">{t('bench.projects.challenge')}</p>
            ...
            <div className="marine-card p-6">
              <p className="flex items-center gap-1.5 text-[13px] font-bold uppercase tracking-[0.1em] text-primary">
                <CheckCircle2 size={15} /> {t('bench.projects.solution')}
              </p>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 md:px-7 md:py-20">
        <SectionHead kicker={t('bench.projects.controlsKicker')} title={t('bench.projects.controlsTitle')} />
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          <div className="marine-card p-7">
            <p className="flex items-center gap-2 text-[13px] font-bold uppercase tracking-[0.1em] text-primary">
              <ShieldCheck size={16} /> {t('bench.projects.qualityLineTitle')}
            </p>
            <p className="mt-4 text-[14.5px] font-bold">{t('bench.projects.qualityBasisLabel')}</p>
            <p className="mt-1.5 text-[14px] leading-relaxed text-fg-2">{t('bench.projects.qualityBasis')}</p>
            <p className="mt-4 text-[14.5px] font-bold">{t('bench.projects.inspectionFocusLabel')}</p>
            ...
            <p className="mt-4 text-[14.5px] font-bold">{t('bench.projects.issueControlLabel')}</p>
            <p className="mt-1.5 text-[14px] leading-relaxed text-fg-2">{t('bench.projects.issueControl')}</p>
            <p className="mt-4 text-[14.5px] font-bold">{t('bench.projects.evidenceLabel')}</p>
            <p className="mt-1.5 text-[14px] leading-relaxed text-fg-2">{t('bench.projects.evidence')}</p>
          </div>
          <div className="marine-card p-7">
            <p className="flex items-center gap-2 text-[13px] font-bold uppercase tracking-[0.1em] text-aqua">
              <Truck size={16} /> {t('bench.projects.deliveryLineTitle')}
            </p>
            <p className="mt-4 text-[14.5px] font-bold">{t('bench.projects.planningInputsLabel')}</p>
            <p className="mt-1.5 text-[14px] leading-relaxed text-fg-2">{t('bench.projects.planningInputs')}</p>
            <p className="mt-4 text-[14.5px] font-bold">{t('bench.projects.milestonesLabel')}</p>
            <p className="mt-1.5 text-[14px] leading-relaxed text-fg-2">{t('bench.projects.milestones')}</p>
            <p className="mt-4 text-[14.5px] font-bold">{t('bench.projects.deliveryReadinessLabel')}</p>
            <p className="mt-1.5 text-[14px] leading-relaxed text-fg-2">{t('bench.projects.deliveryReadiness')}</p>
            <p className="mt-4 text-[14.5px] font-bold">{t('bench.projects.outcomeLabel')}</p>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 md:px-7 md:py-20">
        <SectionHead kicker={t('bench.projects.customKicker')} title={t('bench.projects.customTitle')} />
        <p className="mt-3 max-w-2xl text-[14px] leading-relaxed text-fg-2">{t('bench.projects.customNote')}</p>
      ...
      {/* process */}
      <section className="mx-auto max-w-6xl px-5 py-16 md:px-7 md:py-20">
        <SectionHead kicker={t('bench.projects.processKicker')} title={t('bench.projects.processTitle')} />
      ...
      <section className="border-y border-border bg-bg-alt">
        <div className="mx-auto max-w-3xl px-5 py-16 text-center md:px-7 md:py-20">
          <p className="kicker">{t('bench.projects.result')}</p>
      ...
      <section className="border-y border-border bg-bg-alt">
        <div className="mx-auto max-w-3xl px-5 py-14 md:px-7">
          <SectionHead kicker={t('bench.projects.quoteKicker')} title={t('bench.projects.quoteTitle')} />
      ...
      <section className="ocean-grad">
        <div className="mx-auto flex max-w-4xl flex-col items-center px-5 py-16 text-center md:px-7 md:py-20">
          <p className="font-display text-xs font-bold uppercase tracking-[0.16em] text-[#aee3f7]">{t('bench.projects.ctaKicker')}</p>
          <h2 className="mt-3 font-display text-3xl font-extrabold leading-[1.12] text-white md:text-4xl">{t('bench.projects.ctaTitle')}</h2>
          <a
            href={fl('/contact')}
            className={PRIMARY_CTA}
          >
      ...
      {page.takeaways && (
        <section className="mx-auto max-w-6xl px-5 py-16 md:px-7 md:py-20">
          <SectionHead kicker={t('bench.projects.takeawaysKicker')} title={t('bench.projects.takeawaysTitle')} />
          ...
          <div className="mt-10 rounded-3xl border border-primary/30 bg-primary/5 p-8 text-center md:p-10">
            <h3 className="font-display text-xl font-extrabold">{t('bench.projects.scenarioCtaTitle')}</h3>
            <p className="mx-auto mt-2 max-w-xl text-[14px] leading-relaxed text-fg-2">{t('bench.projects.scenarioCtaBody')}</p>
            <a
              href={fl('/contact')}
            ...
            >
              {t('bench.projects.discuss')} <ArrowRight size={16} />
            </a>
          </div>
        </section>
      )}
      ...
      {related.length > 0 && (
        <section className="border-y border-border bg-bg-alt">
          <div className="mx-auto max-w-6xl px-5 py-16 md:px-7">
            <SectionHead kicker={t('bench.projects.similarKicker')} title={t('bench.projects.similarTitle')} />
      ...
      <nav className="mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-2 gap-y-1 px-5 py-12 md:px-7">
        <a href={fl('/projects')} className="text-[13px] font-medium text-primary hover:underline">{t('bench.projects.seeAll')}</a>
        <span className="text-fg-3">·</span>
        <a href={fl('/solutions')} className="text-[13px] font-medium text-primary hover:underline">{t('bench.nav.solutions')}</a>
        <span className="text-fg-3">·</span>
