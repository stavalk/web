...
export const hero: Localized<HeroContent> = {
  en: {
    ...
    titlePre: 'Custom Bench Vise Manufacturing for',
    titleAccent: 'Brands, Distributors & Industrial Buyers',
    titlePost: '',
    sub: 'OEM, ODM and private-label bench vises — from specification review and sample development to quality-controlled batch production in Qingdao, China.',
  ...
  es: {
    ...
    titlePre: 'Fabricación de tornillos de banco a medida para',
    titleAccent: 'marcas, distribuidores y compradores industriales',
    titlePost: '',
    sub: 'Tornillos de banco OEM, ODM y marca privada — desde la revisión de especificaciones y el desarrollo de muestras hasta la producción en serie con control de calidad en Qingdao, China.',
  ...
  fr: {
    ...
    titlePre: 'Fabrication d’étaux d’établi sur mesure pour',
    titleAccent: 'marques, distributeurs et acheteurs industriels',
    titlePost: '',
    sub: 'Étaux d’établi OEM, ODM et marque privée — de l’examen des spécifications et du développement des échantillons à la production en série sous contrôle qualité à Qingdao, en Chine.',
  ...
  en: {
    ...
    segments: [
      ...
      },
      {
        ...
        cta: 'Learn More',
        href: '/solutions/private-label-vise',
      },
      {
    ...
    items: [
      {
        ...
        series: 'light-duty',
        sku: 'VISE-LD4',
        name: 'Light-Duty 4" Vise',
        tagline: 'The home workshop classic',
        desc: 'A compact cast-iron vise for hobbyists and light maintenance — smooth clamping for everyday home, hobby and craft work. The default starting point for most new tool brands.',
        uses: ['Home Workshop', 'Hobby', 'Light Maintenance'],
        for: ['Tool startups', 'Retail lines'],
        specs: '4" jaw width · 3" opening · cast iron · 58–62 HRC jaws',
        artwork: 'Precision-machined body · hardened serrated jaws · anvil · complete package',
      ...
      },
      {
        ...
        series: 'light-duty',
        sku: 'VISE-LD5',
        name: 'Light-Duty 5" Vise',
        tagline: 'Versatile home and bench classic',
        desc: 'A wider light-duty body with a built-in anvil and integrated pipe jaws, ideal for garage benches, craft tables and general DIY. Engineered to stay accurate under everyday use.',
        uses: ['Garage', 'DIY', 'Craft'],
        for: ['Hardware chains', 'Retail lines'],
        specs: '5" jaw width · 4" opening · cast iron · pipe jaws',
        artwork: 'Full-width hardened jaws · integrated anvil · pipe jaws · anti-distortion geometry',
      ...
      },
      {
        ...
        series: 'medium-duty',
        sku: 'VISE-MD6',
        name: 'Medium-Duty 6" Vise',
        tagline: 'The professional workhorse',
        desc: 'Our most popular professional vise — wide-body stability for metalworking, woodworking and assembly, with a swivel base and quick-release for fast repositioning.',
        uses: ['Metalworking', 'Woodworking', 'Assembly'],
        for: ['Professional brands', 'Educational institutions'],
        specs: '6" jaw width · 6" opening · ductile iron · swivel base',
        artwork: 'Ductile iron body · quick-release · swivel base · hardened jaws',
      ...
      },
      {
        ...
        series: 'medium-duty',
        sku: 'VISE-MD8',
        name: 'Medium-Duty 8" Vise',
        tagline: 'Big capacity, precise control',
        desc: 'An 8-inch medium-duty body for larger workpieces, with double guide bars, a swivel base and anvils for maximum versatility in professional workshops.',
        uses: ['Machining', 'Workshop', 'Maintenance'],
        for: ['Workshops', 'Fabricators'],
        specs: '8" jaw width · 8" opening · gray iron · double guide bars',
        artwork: 'Double guide bars · swivel base · anvil · drop-in jaw caps',
      ...
      },
      {
        ...
        series: 'heavy-duty',
        sku: 'VISE-HD6',
        name: 'Heavy-Duty 6" Vise',
        tagline: 'Forged for demanding work',
        desc: 'A heavy-duty forged-steel vise built for serious clamping force — ideal for metalworking, fabrication and industrial maintenance where rigidity and repeatability decide the result.',
        uses: ['Metalworking', 'Fabrication', 'Industrial'],
        for: ['Industrial brands', 'Heavy users'],
        specs: '6" jaw width · 6" opening · forged steel · 2,000–5,000 lbs clamp',
        artwork: 'Forged-steel body · hardened jaws to 62 HRC · replaceable screw assembly',
      ...
      },
      {
        ...
        series: 'heavy-duty',
        sku: 'VISE-HD8',
        name: 'Heavy-Duty 8" Vise',
        tagline: 'Industrial-grade grip',
        desc: 'An 8-inch heavy-duty vise with a reinforced cast-iron body and high clamping force for pipe fitting, welding tables and heavy fabrication benches.',
        uses: ['Pipe Fitting', 'Welding', 'Heavy Fabrication'],
        for: ['Industrial suppliers', 'Contractors'],
        specs: '8" jaw width · 8" opening · reinforced cast iron · 2,000–5,000 lbs clamp',
        artwork: 'Reinforced body · hardened jaws · swivel base with lock',
      ...
      },
      {
        ...
        series: 'specialty',
        sku: 'VISE-SP01',
        name: 'Specialty Swivel Vise',
        tagline: 'Full 360° positioning',
        desc: 'A specialty bench vise on a full 360° swivel base with a spring-loaded release — ideal for angled clamping, assembly benches and operators who reposition work frequently.',
        uses: ['Assembly', 'Positioning', 'Benchwork'],
        for: ['Innovative brands', 'Assembly lines'],
        specs: '4–5" jaw width · 360° swivel · quick-release',
        artwork: '360° swivel base · spring-loaded release · hardened jaws',
        image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-01.avif',
        hue: 170,
      },
      {
        slug: 'vise-specialty-multi',
        series: 'specialty',
        sku: 'VISE-SP02',
        name: 'Specialty Multi-Vise',
        tagline: 'Five workstations, one base',
        desc: 'A specialty rotating multi-vise with five integral stations — for production environments, schools and workshops that need consistent, quick clamping across multiple setups.',
        uses: ['Production', 'Schools', 'Multi-station'],
        for: ['Educational suppliers', 'Production shops'],
        specs: '3" each jaw · 5 rotating stations · cast iron',
        artwork: 'Rotating multi-vise body · five stations · hardened jaws',
    ...
    items: [
      {
        ...
        series: 'light-duty',
        sku: 'VISE-LD4',
        name: 'Tornillo de uso ligero 4"',
        tagline: 'El clásico del taller casero',
        desc: 'Un tornillo de hierro fundido compacto para aficionados y mantenimiento ligero — cierre suave para trabajo cotidiano en el hogar, hobby y artesanía. El punto de partida por defecto para la mayoría de las nuevas marcas de herramientas.',
        uses: ['Taller casero', 'Hobby', 'Mantenimiento ligero'],
        for: ['Marcas emergentes de herramientas', 'Líneas de retail'],
        specs: 'Ancho de mordaza 4" · apertura 3" · hierro fundido · mordazas 58–62 HRC',
        artwork: 'Cuerpo mecanizado de precisión · mordazas dentadas templadas · yunque · paquete completo',
        image: 'https://assets.Stavalk.com/site/products/2026/light-duty/light-duty-01.avif',
        hue: 195,
      },
      {
        ...
        series: 'light-duty',
        sku: 'VISE-LD5',
        name: 'Tornillo de uso ligero 5"',
        tagline: 'Clásico versátil de banco y hogar',
        desc: 'Un cuerpo de uso ligero más ancho con yunque integrado y mordazas tubulares, ideal para bancos de garaje, mesas de artesanía y bricolaje general.',
        uses: ['Garaje', 'Bricolaje', 'Artesanía'],
        for: ['Cadenas de ferretería', 'Líneas de retail'],
        specs: 'Ancho de mordaza 5" · apertura 4" · hierro fundido · mordazas tubulares',
        artwork: 'Mordazas templadas a todo ancho · yunque integrado · mordazas tubulares · geometría antideformación',
        image: 'https://assets.Stavalk.com/site/products/2026/light-duty/light-duty-02.avif',
        hue: 28,
      },
      {
        ...
        series: 'medium-duty',
        sku: 'VISE-MD6',
        name: 'Tornillo de uso medio 6"',
        tagline: 'El caballo de batalla profesional',
        desc: 'Nuestro tornillo profesional más popular — estabilidad de cuerpo ancho para metalurgia, carpintería y montaje, con base giratoria y liberación rápida.',
        uses: ['Metalurgia', 'Carpintería', 'Montaje'],
        for: ['Marcas profesionales', 'Instituciones educativas'],
        specs: 'Ancho de mordaza 6" · apertura 6" · hierro dúctil · base giratoria',
        artwork: 'Cuerpo de hierro dúctil · liberación rápida · base giratoria · mordazas templadas',
        image: 'https://assets.Stavalk.com/site/products/2026/medium-duty/medium-duty-01.avif',
        hue: 210,
      },
      {
        ...
        series: 'medium-duty',
        sku: 'VISE-MD8',
        name: 'Tornillo de uso medio 8"',
        tagline: 'Gran capacidad, control preciso',
        desc: 'Un cuerpo de uso medio de 8 pulgadas para piezas más grandes, con doble barra guía, base giratoria y yunques para máxima versatilidad en talleres profesionales.',
        uses: ['Mecanizado', 'Taller', 'Mantenimiento'],
        for: ['Talleres', 'Fabricantes'],
        specs: 'Ancho de mordaza 8" · apertura 8" · hierro gris · doble barra guía',
        artwork: 'Doble barra guía · base giratoria · yunque · cubiertas de mordaza de inserción',
        image: 'https://assets.Stavalk.com/site/products/2026/medium-duty/medium-duty-02.avif',
        hue: 170,
      },
      {
        ...
        series: 'heavy-duty',
        sku: 'VISE-HD6',
        name: 'Tornillo de uso intensivo 6"',
        tagline: 'Forjado para trabajo exigente',
        desc: 'Un tornillo de acero forjado para uso intensivo, construido para fuerza de cierre seria — ideal para metalurgia, fabricación y mantenimiento industrial donde la rigidez decide el resultado.',
        uses: ['Metalurgia', 'Fabricación', 'Industrial'],
        for: ['Marcas industriales', 'Usuarios exigentes'],
        specs: 'Ancho de mordaza 6" · apertura 6" · acero forjado · cierre de 2.000–5.000 lbs',
        artwork: 'Cuerpo de acero forjado · mordazas templadas a 62 HRC · conjunto de husillo reemplazable',
        image: 'https://assets.Stavalk.com/site/products/2026/heavy-duty/heavy-duty-01.avif',
        hue: 260,
      },
      {
        ...
        series: 'heavy-duty',
        sku: 'VISE-HD8',
        name: 'Tornillo de uso intensivo 8"',
        tagline: 'Sujeción de grado industrial',
        desc: 'Un tornillo de uso intensivo de 8 pulgadas con cuerpo de hierro fundido reforzado y alta fuerza de cierre para instalación de tuberías, mesas de soldadura y bancos de fabricación pesada.',
        uses: ['Instalación de tuberías', 'Soldadura', 'Fabricación pesada'],
        for: ['Proveedores industriales', 'Contratistas'],
        specs: 'Ancho de mordaza 8" · apertura 8" · hierro fundido reforzado · cierre de 2.000–5.000 lbs',
        artwork: 'Cuerpo reforzado · mordazas templadas · base giratoria con bloqueo',
        image: 'https://assets.Stavalk.com/site/products/2026/heavy-duty/heavy-duty-02.avif',
        hue: 195,
      },
      {
      ...
      },
      {
        ...
        series: 'specialty',
        sku: 'VISE-SP01',
        name: 'Tornillo giratorio especial',
        tagline: 'Posicionamiento completo de 360°',
        desc: 'Un tornillo de banco especial sobre base giratoria completa de 360° con liberación por muelle — ideal para sujeción en ángulo, bancos de montaje y operadores que reposicionan la pieza con frecuencia.',
        uses: ['Montaje', 'Posicionamiento', 'Trabajo de banco'],
        for: ['Marcas innovadoras', 'Líneas de montaje'],
        specs: 'Ancho de mordaza 4–5" · giro de 360° · liberación rápida',
        artwork: 'Base giratoria de 360° · liberación por muelle · mordazas templadas',
        image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-01.avif',
        hue: 170,
      },
      {
        ...
        series: 'specialty',
        sku: 'VISE-SP02',
        name: 'Multitornillo especial',
        tagline: 'Cinco estaciones, una base',
        desc: 'Un multitornillo giratorio especial con cinco estaciones integradas — para entornos de producción, escuelas y talleres que necesitan una sujeción consistente y rápida en múltiples configuraciones.',
        uses: ['Producción', 'Escuelas', 'Multi-estación'],
        for: ['Proveedores educativos', 'Talleres de producción'],
        specs: '3" cada mordaza · 5 estaciones giratorias · hierro fundido',
        artwork: 'Cuerpo de multitornillo giratorio · cinco estaciones · mordazas templadas',
        image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-02.avif',
        hue: 330,
      },
    ],
    ...
    items: [
      {
        ...
        series: 'light-duty',
        sku: 'VISE-LD4',
        name: 'Étau usage léger 4"',
        tagline: 'Le classique de l’atelier à domicile',
        desc: 'Un étau compact en fonte pour les amateurs et l’entretien léger — un serrage fluide pour le travail quotidien à la maison, le hobby et l’artisanat. Le point de départ par défaut de la plupart des nouvelles marques d’outillage.',
        uses: ['Atelier maison', 'Hobby', 'Entretien léger'],
        for: ['Startups d’outillage', 'Gammes retail'],
        specs: 'Largeur de mâchoire 4" · ouverture 3" · fonte · mâchoires 58–62 HRC',
        artwork: 'Corps usiné de précision · mâchoires striées trempées · enclume · ensemble complet',
        image: 'https://assets.Stavalk.com/site/products/2026/light-duty/light-duty-01.avif',
        hue: 195,
      },
      {
        ...
        series: 'light-duty',
        sku: 'VISE-LD5',
        name: 'Étau usage léger 5"',
        tagline: 'Classique polyvalent maison et établi',
        desc: 'Un corps usage léger plus large avec enclume intégrée et mâchoires de tube, idéal pour les établis de garage, les tables d’artisanat et le bricolage général.',
        uses: ['Garage', 'Bricolage', 'Artisanat'],
        for: ['Chaînes de quincaillerie', 'Gammes retail'],
        specs: 'Largeur de mâchoire 5" · ouverture 4" · fonte · mâchoires de tube',
        artwork: 'Mâchoires trempées pleine largeur · enclume intégrée · mâchoires de tube · géométrie antiforme',
        image: 'https://assets.Stavalk.com/site/products/2026/light-duty/light-duty-02.avif',
        hue: 28,
      },
      {
        ...
        series: 'medium-duty',
        sku: 'VISE-MD6',
        name: 'Étau usage moyen 6"',
        tagline: 'Le cheval de bataille professionnel',
        desc: 'Notre étau professionnel le plus populaire — stabilité de corps large pour le travail des métaux, le bois et l’assemblage, avec base pivotante et libération rapide.',
        uses: ['Travail des métaux', 'Menuiserie', 'Assemblage'],
        for: ['Marques professionnelles', 'Institutions éducatives'],
        specs: 'Largeur de mâchoire 6" · ouverture 6" · fonte ductile · base pivotante',
        artwork: 'Corps en fonte ductile · libération rapide · base pivotante · mâchoires trempées',
        image: 'https://assets.Stavalk.com/site/products/2026/medium-duty/medium-duty-01.avif',
        hue: 210,
      },
      {
        ...
        series: 'medium-duty',
        sku: 'VISE-MD8',
        name: 'Étau usage moyen 8"',
        tagline: 'Grande capacité, contrôle précis',
        desc: 'Un corps usage moyen de 8 pouces pour les pièces plus grandes, avec double barre de guidage, base pivotante et enclumes pour une polyvalence maximale dans les ateliers professionnels.',
        uses: ['Usinage', 'Atelier', 'Maintenance'],
        for: ['Ateliers', 'Fabricants'],
        specs: 'Largeur de mâchoire 8" · ouverture 8" · fonte grise · double barre de guidage',
        artwork: 'Double barre de guidage · base pivotante · enclume · capuchons de mâchoire',
        image: 'https://assets.Stavalk.com/site/products/2026/medium-duty/medium-duty-02.avif',
        hue: 170,
      },
      {
        ...
        series: 'heavy-duty',
        sku: 'VISE-HD6',
        name: 'Étau usage intensif 6"',
        tagline: 'Forgé pour les travaux exigeants',
        desc: 'Un étau en acier forgé à usage intensif, conçu pour une force de serrage sérieuse — idéal pour le travail des métaux, la fabrication et la maintenance industrielle où la rigidité fait la différence.',
        uses: ['Travail des métaux', 'Fabrication', 'Industriel'],
        for: ['Marques industrielles', 'Utilisateurs exigeants'],
        specs: 'Largeur de mâchoire 6" · ouverture 6" · acier forgé · serrage 2 000–5 000 lbs',
        artwork: 'Corps en acier forgé · mâchoires trempées à 62 HRC · ensemble vis remplaçable',
        image: 'https://assets.Stavalk.com/site/products/2026/heavy-duty/heavy-duty-01.avif',
        hue: 260,
      },
      {
        ...
        series: 'heavy-duty',
        sku: 'VISE-HD8',
        name: 'Étau usage intensif 8"',
        tagline: 'Pince de niveau industriel',
        desc: 'Un étau à usage intensif de 8 pouces avec corps en fonte renforcé et force de serrage élevée, pour le raccordement de tuyauterie, les tables de soudage et les établis de fabrication lourde.',
        uses: ['Raccordement de tuyauterie', 'Soudage', 'Fabrication lourde'],
        for: ['Fournisseurs industriels', 'Entrepreneurs'],
        specs: 'Largeur de mâchoire 8" · ouverture 8" · fonte renforcée · serrage 2 000–5 000 lbs',
        artwork: 'Corps renforcé · mâchoires trempées · base pivotante avec verrou',
        image: 'https://assets.Stavalk.com/site/products/2026/heavy-duty/heavy-duty-02.avif',
        hue: 195,
      },
      {
      ...
      },
      {
        ...
        series: 'specialty',
        sku: 'VISE-SP01',
        name: 'Étau pivotant spécial',
        tagline: 'Positionnement complet à 360°',
        desc: 'Un étau d’établi spécial sur base pivotante complète à 360° avec dégagement à ressort — idéal pour le serrage en angle, les établis d’assemblage et les opérateurs qui repositionnent fréquemment la pièce.',
        uses: ['Assemblage', 'Positionnement', 'Travail d’établi'],
        for: ['Marques innovantes', 'Lignes d’assemblage'],
        specs: 'Largeur de mâchoire 4–5" · pivotement 360° · libération rapide',
        artwork: 'Base pivotante 360° · dégagement à ressort · mâchoires trempées',
        image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-01.avif',
        hue: 170,
      },
      {
        ...
        series: 'specialty',
        sku: 'VISE-SP02',
        name: 'Multi-étau spécial',
        tagline: 'Cinq postes, une seule base',
        desc: 'Un multi-étau rotatif spécial avec cinq postes intégrés — pour les environnements de production, les écoles et les ateliers qui ont besoin d’un serrage constant et rapide sur plusieurs configurations.',
        uses: ['Production', 'Écoles', 'Multi-postes'],
        for: ['Fournisseurs éducatifs', 'Ateliers de production'],
        specs: '3" chaque mâchoire · 5 postes rotatifs · fonte',
        artwork: 'Corps de multi-étau rotatif · cinq postes · mâchoires trempées',
        image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-02.avif',
        hue: 330,
      },
    ],
...
export const boardCategories: Localized<BoardCategoriesContent> = {
  en: {
    ...
    viewLabel: 'View',
    items: [
      { id: 'light-duty', label: 'Light-Duty', desc: 'Compact cast-iron vises for home, hobby and light maintenance work.', image: 'https://assets.Stavalk.com/site/products/2026/light-duty/light-duty-01.avif', href: '/products/vise-light-4' },
      { id: 'medium-duty', label: 'Medium-Duty', desc: 'Versatile ductile-iron vises for professional workshops and schools.', image: 'https://assets.Stavalk.com/site/products/2026/medium-duty/medium-duty-01.avif', href: '/products/vise-medium-6' },
      { id: 'heavy-duty', label: 'Heavy-Duty', desc: 'Forged-steel vises engineered for fabrication, industrial and demanding work.', image: 'https://assets.Stavalk.com/site/products/2026/heavy-duty/heavy-duty-01.avif', href: '/products/vise-heavy-6' },
      { id: 'pipe', label: 'Pipe', desc: 'Self-centering vises for pipe and tube work in plumbing and fitting.', image: 'https://assets.Stavalk.com/site/products/2026/pipe/pipe-01.avif', href: '/products/vise-pipe-4' },
      { id: 'specialty', label: 'Specialty', desc: 'Swivel and multi-station vises for positioning and production work.', image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-01.avif', href: '/products/vise-specialty-swivel' },
    ],
  },
  es: {
    ...
    viewLabel: 'Ver',
    items: [
      { id: 'light-duty', label: 'Uso ligero', desc: 'Tornillos de hierro fundido compactos para el hogar, el hobby y el mantenimiento ligero.', image: 'https://assets.Stavalk.com/site/products/2026/light-duty/light-duty-01.avif', href: '/products/vise-light-4' },
      { id: 'medium-duty', label: 'Uso medio', desc: 'Tornillos de hierro dúctil versátiles para talleres profesionales y escuelas.', image: 'https://assets.Stavalk.com/site/products/2026/medium-duty/medium-duty-01.avif', href: '/products/vise-medium-6' },
      { id: 'heavy-duty', label: 'Uso intensivo', desc: 'Tornillos de acero forjado diseñados para fabricación, uso industrial y trabajo exigente.', image: 'https://assets.Stavalk.com/site/products/2026/heavy-duty/heavy-duty-01.avif', href: '/products/vise-heavy-6' },
      { id: 'pipe', label: 'Tubería', desc: 'Tornillos autocentrantes para tubos y tuberías en fontanería y ajuste.', image: 'https://assets.Stavalk.com/site/products/2026/pipe/pipe-01.avif', href: '/products/vise-pipe-4' },
      { id: 'specialty', label: 'Especial', desc: 'Tornillos giratorios y multi-estación para posicionamiento y producción.', image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-01.avif', href: '/products/vise-specialty-swivel' },
    ],
  },
  fr: {
    kicker: 'Nos Étaux',
    ...
    viewLabel: 'Voir',
    items: [
      { id: 'light-duty', label: 'Usage léger', desc: 'Étaux en fonte compacts pour la maison, le hobby et l\'entretien léger.', image: 'https://assets.Stavalk.com/site/products/2026/light-duty/light-duty-01.avif', href: '/products/vise-light-4' },
      { id: 'medium-duty', label: 'Usage moyen', desc: 'Étaux en fonte ductile polyvalents pour les ateliers professionnels et les écoles.', image: 'https://assets.Stavalk.com/site/products/2026/medium-duty/medium-duty-01.avif', href: '/products/vise-medium-6' },
      { id: 'heavy-duty', label: 'Usage intensif', desc: 'Étaux en acier forgé conçus pour la fabrication, l\'industrie et les travaux exigeants.', image: 'https://assets.Stavalk.com/site/products/2026/heavy-duty/heavy-duty-01.avif', href: '/products/vise-heavy-6' },
      { id: 'pipe', label: 'Tuyauterie', desc: 'Étaux auto-centrants pour tubes et tuyauterie en plomberie et ajustage.', image: 'https://assets.Stavalk.com/site/products/2026/pipe/pipe-01.avif', href: '/products/vise-pipe-4' },
      { id: 'specialty', label: 'Spécial', desc: 'Étaux pivotants et multi-postes pour le positionnement et la production.', image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-01.avif', href: '/products/vise-specialty-swivel' },
    ],
  },
}
    ...
    items: [
      {
        ...
        image: 'https://assets.Stavalk.com/site/products/2026/editions/heavy-duty-forged.avif',
        href: '/products/vise-heavy-6',
      },
      {
        title: 'Light-Duty Series (Home Workshop)',
        sku: 'VISE-LD4',
        body: 'Compact cast-iron vises with hardened serrated jaws and a built-in anvil — ideal for home, hobby and craft work.',
        image: 'https://assets.Stavalk.com/site/products/2026/editions/light-duty-home.avif',
  ...
  es: {
    ...
    items: [
      ...
      },
      {
        ...
        sku: 'VISE-LD4',
        body: 'Tornillos compactos de hierro fundido con mordazas dentadas templadas y yunque integrado — ideales para el hogar, el hobby y la artesanía.',
        image: 'https://assets.Stavalk.com/site/products/2026/editions/light-duty-home.avif',
        href: '/products/vise-light-4',
      },
    ],
  ...
  fr: {
    ...
    items: [
      ...
      },
      {
        ...
        sku: 'VISE-LD4',
        body: 'Étaux compacts en fonte avec mâchoires striées trempées et enclume intégrée — idéaux pour la maison, le hobby et l\'artisanat.',
        image: 'https://assets.Stavalk.com/site/products/2026/editions/light-duty-home.avif',
        href: '/products/vise-light-4',
      },
    ],
