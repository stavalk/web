...
export const boardCategories: Localized<BoardCategoriesContent> = {
  en: {
    ...
    items: [
      ...
      { id: 'specialty', label: 'Specialty', desc: 'Swivel and multi-station vises for positioning and production work.', image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-01.webp', href: '/products/vise-specialty-swivel' },
    ],
  },
  es: {
    ...
    items: [
      ...
      { id: 'specialty', label: 'Especial', desc: 'Tornillos giratorios y multi-estación para posicionamiento y producción.', image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-01.webp', href: '/products/vise-specialty-swivel' },
    ],
  },
  fr: {
    kicker: 'Nos Étaux',
    ...
    items: [
      ...
      { id: 'specialty', label: 'Spécial', desc: 'Étaux pivotants et multi-postes pour le positionnement et la production.', image: 'https://assets.Stavalk.com/site/products/2026/specialty/specialty-01.webp', href: '/products/vise-specialty-swivel' },
    ],
  },
}
