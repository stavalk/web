...
export const EDGE_REDIRECTS: Record<string, string> = {
  ...
  '/news/stavalk-supply-chain-2025': '/news',
  ...
  '/fournisseur-nautique': '/solutions',
  '/es/fournisseur-nautique': '/es/solutions',
  '/oem-paddle': '/oem-manufacturing',
  '/es/oem-paddle': '/es/oem-manufacturing',
  '/zh/oem-paddle': '/es/oem-manufacturing',
  ...
  '/solutions/resorts-hotels': '/solutions',
  '/es/solutions/resorts-hotels': '/es/solutions',
  '/solutions/paddle-clubs': '/solutions',
  '/es/solutions/paddle-clubs': '/es/solutions',
  '/solutions/build-your-own-brand': '/solutions/private-label-vises',
  '/es/solutions/build-your-own-brand': '/es/solutions/private-label-vises',
  '/afarer': ABOUT_BRAND_PATH,
  '/es/afarer': '/es/about/stavalk',
  '/zh/afarer': '/es/about/stavalk',
  '/brand': '/about',
  '/es/brand': '/es/about',
  '/zh/brand': '/es/about',
  '/brand/afarer': ABOUT_BRAND_PATH,
  '/es/brand/afarer': '/es/about/stavalk',
  '/zh/brand/afarer': '/es/about/stavalk',
  '/brand/story': ABOUT_BRAND_PATH,
  '/es/brand/story': '/es/about/stavalk',
  '/zh/brand/story': '/es/about/stavalk',
  ...
  '/es/brand/why-afarer': '/es/about/stavalk',
  ...
  '/news/sup-oem-shipping-logistics': '/news/factory-capacity-80000-vises',
