...
export const procurementProfiles: Localized<Record<string, ProcurementProfile>> = {
  en: {
    ...
    specialty: {
      bestFor: 'Angled clamping, anvil benchwork & multi-angle positioning',
      sizes: 'Custom jaw/swivel configurations per spec',
      construction: 'ADI cast steel or ductile iron body with hardened jaws',
      customization: 'Jaw geometry, anvil size & shape, swivel lock, finish',
      moq: `From ${MOQ_SHORT.standardRun} pcs per project — trial runs from ${MOQ_SHORT.trialStandard}`,
      leadTime: `Samples in ${FACTS.sampleTime} · production in ${FACTS.leadTime} after confirmed PO and deposit`,
      specRows: [
        { label: 'Use scenario', value: 'Angled clamping, anvil benchwork & multi-angle positioning' },
        { label: 'Available sizes', value: 'Custom jaw/swivel configurations per spec' },
        { label: 'Construction', value: 'ADI cast steel or ductile iron body' },
        { label: 'Jaw steel & hardness', value: 'Hardened jaws at 58–62 HRC' },
  ...
  es: {
    ...
    specialty: {
      bestFor: 'Sujeción en ángulo, trabajo de yunque en banco y posicionamiento multiángulo',
      sizes: 'Configuraciones personalizadas de mordaza/giratoria según especificación',
      construction: 'Cuerpo de ADI o hierro dúctil con mordazas endurecidas',
      customization: 'Geometría de mordaza, tamaño y forma de yunque, bloqueo de giro y acabado',
      moq: `Desde ${MOQ_SHORT.standardRun} uds. por proyecto — pedidos de prueba desde ${MOQ_SHORT.trialStandard}`,
      leadTime: `Muestras en ${FACTS.sampleTime} · producción en ${FACTS.leadTime} tras confirmar PO y depósito`,
      specRows: [
        { label: 'Escenario de uso', value: 'Sujeción en ángulo, trabajo de yunque en banco y posicionamiento multiángulo' },
        { label: 'Tamaños disponibles', value: 'Configuraciones personalizadas de mordaza/giratoria según especificación' },
        { label: 'Construcción', value: 'Cuerpo de ADI o hierro dúctil' },
        { label: 'Acero y dureza de mordaza', value: 'Mordazas endurecidas a 58–62 HRC' },
  ...
  fr: {
    ...
    specialty: {
      bestFor: 'Bridage angulaire, travail d’enclume sur établi et positionnement multi-angles',
      sizes: 'Configurations personnalisées mâchoire/pivotante selon spécification',
      construction: 'Corps en ADI ou fonte ductile avec mâchoires durcies',
      customization: 'Géométrie de mâchoire, taille et forme d’enclume, verrouillage pivotant et finition',
      moq: `À partir de ${MOQ_SHORT.standardRun} pièces par projet — séries d’essai dès ${MOQ_SHORT.trialStandard}`,
      leadTime: `Échantillons en ${FACTS.sampleTime} · production en ${FACTS.leadTime} après confirmation du bon de commande et du dépôt`,
      specRows: [
        { label: 'Scénario d’utilisation', value: 'Bridage angulaire, travail d’enclume sur établi et positionnement multi-angles' },
        { label: 'Tailles disponibles', value: 'Configurations personnalisées mâchoire/pivotante selon spécification' },
        { label: 'Construction', value: 'Corps en ADI ou fonte ductile' },
        { label: 'Acier et dureté des mâchoires', value: 'Mâchoires durcies à 58–62 HRC' },
