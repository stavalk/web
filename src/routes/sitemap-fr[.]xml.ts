...
// detail content (news/products/technology/case-use/guides) that ship a real
// French variant.
//
...
const handler = async () => {
  ...
  return new Response(buildLocaleSitemap(origin, 'fr', [...PUBLIC_PATHS, ...detailFr, ...afarerFr]), {
